...
int main() {
	...
	Packet msg;
		...
		char* ser="10.176.67.65";
		int dest_port=1234;
		com.sendMessage(msg,ser,dest_port);
...
/*	Packet *message1;
	...
	ConsumerThread* thread1 = new ConsumerThread(queue);
	 thread1->start();
	pthread_t thread1;
	pthread_create(&thread1, NULL, process, (void *)&queue);*/
...
/*	pthread_t thread2;
	...
	pthread_create(&thread2, NULL, listner, (void *)&queue);
